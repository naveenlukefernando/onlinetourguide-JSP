...
<html lang="en">
<head>
    <title>Contact | PARADISE TRAVELS | Online Tour Guide</title>
    <meta charset="utf-8">
        ...
        <div class="row d-flex contact-info">
            <div class="col-md-3 d-flex">
                <div class="align-self-stretch box p-4 text-center">
                    ...
                    <p>No: 120 , Galle Road , Colombo 11</p>
                </div>
            </div>
            <div class="col-md-3 d-flex">
                <div class="align-self-stretch box p-4 text-center">
                    ...
                    <p><a href="tel://1234567920">+ 9477 2355 98</a></p>
                </div>
            </div>
            <div class="col-md-3 d-flex">
                <div class="align-self-stretch box p-4 text-center">
                    ...
                    <p><a href="mailto:info@yoursite.com">info@paradisetravels.com</a></p>
                </div>
            </div>
            <div class="col-md-3 d-flex">
                <div class="align-self-stretch box p-4 text-center">
                    ...
                    <p><a href="#">www.paradisetravels.lk</a></p>
                </div>
            </div>
        </div>
    </div>
