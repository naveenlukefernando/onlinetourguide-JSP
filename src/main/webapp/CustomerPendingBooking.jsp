...
<html lang="en">
<head>
    <title>Current Bookings | PARADISE TRAVELS | Online Tour Guide </title>
    <meta charset="utf-8">
                                        ...
                                        <td>
                                            <div class="text-center">
                                                ...
                                                <% if (t.isBook_status()) {
                                                    ...
                                                    out.print("  <div class=\"alert alert-warning\"><strong> Thank you for book with us. <br> Booking Confirmation Pending.. </strong></div>");
                                                }
                                                %>
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p>A successful visit to Sri Lanka depends on having an expert tour guide at your disposal. We look forward to meeting you, and to helping to make your visit an unforgettable success! We have long experience of the country,
                        its customs and traditions, and its many astonishing historical and cultural sites.</p>
